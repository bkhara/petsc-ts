...
PetscErrorCode FormFunctionLocal(DMDALocalInfo *info, Field *au, Field *aG, const HeatCtx *user) {
    PetscErrorCode ierr;
    int      i, j, mx = info->mx;
...
PetscErrorCode FormJacobianLocal(DMDALocalInfo *info, Field *au, Mat J, Mat P, const HeatCtx *user) {
    PetscErrorCode ierr;
...
int main(int argc,char **argv)
{
    ...
    ierr = SNESSolve(snes, nullptr, u); CHKERRQ(ierr);
